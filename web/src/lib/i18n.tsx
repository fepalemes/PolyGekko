...
const T = {
  en: {
    ...
    settings: {
      ...
      groupKelly: 'Kelly Criterion',
      groupLists: 'Market Lists',
      groupSimulation: 'Simulation',
      groupAdaptive: 'Adaptive Logic',
      groupBinance: 'Binance Trend',
      groupEntryFilters: 'Entry Filters',
      groupEarlyExit: 'Early Exit',
      groupTiers: 'Price Tiers',
      groupSchedule: 'Schedule & Multipliers',
      groupGlobal: 'Global Limits',
    },

    tradingMode: {
      title: 'Trading Mode',
      description: 'Select a preset that configures all strategy parameters at once. The active mode is saved and applied automatically on startup. Switch to Custom to configure manually.',
      active: 'Active',
      apply: 'Apply',
      applied: 'Applied!',
      high: 'High Risk',
      highDesc: 'Large positions, fast entries, loose filters. Maximum return potential, maximum risk.',
      intermediate: 'Intermediate',
      intermediateDesc: 'Balanced approach. Moderate position sizes and conservative entry filters.',
      low: 'Low Risk',
      lowDesc: 'Small positions, strict filters, early exit on 25% loss. Capital preservation first.',
      custom: 'Custom',
      customDesc: 'Manage all settings manually. Selecting this only saves the mode flag without changing any parameter.',
      positionSize: 'Position size',
      stopLoss: 'Stop-loss',
      entryFilter: 'Entry filter',
      maxEntries: 'Max entries/min',
  ...
  pt: {
    ...
    settings: {
      ...
      importApplied: 'aplicadas',
      importSkipped: 'ignoradas',
      history: 'Histórico',
      ...
      groupGeneral: 'Geral',
      groupSizing: 'Tamanho de Posição',
      groupRisk: 'Risco & Saídas',
      groupFilters: 'Filtros de Entrada',
      groupTimings: 'Intervalos',
      groupKelly: 'Critério de Kelly',
      groupLists: 'Listas de Mercados',
      groupSimulation: 'Simulação',
      groupAdaptive: 'Lógica Adaptativa',
      groupBinance: 'Tendência Binance',
      groupEntryFilters: 'Filtros de Entrada',
      groupEarlyExit: 'Saída Antecipada',
      groupTiers: 'Faixas de Preço',
      groupSchedule: 'Agenda & Multiplicadores',
      groupGlobal: 'Limites Globais',
    },

    tradingMode: {
      title: 'Modo de Trade',
      description: 'Selecione um preset que configura todos os parâmetros de estratégia de uma vez. O modo ativo é salvo e aplicado automaticamente na inicialização. Escolha Personalizado para configurar manualmente.',
      active: 'Ativo',
      apply: 'Aplicar',
      applied: 'Aplicado!',
      high: 'Alto Risco',
      highDesc: 'Posições grandes, entradas rápidas, filtros flexíveis. Máximo potencial de retorno, máximo risco.',
      intermediate: 'Intermediário',
      intermediateDesc: 'Abordagem equilibrada. Tamanhos moderados e filtros conservadores de entrada.',
      low: 'Baixo Risco',
      lowDesc: 'Posições pequenas, filtros rigorosos, saída antecipada com 25% de perda. Preservação de capital em primeiro lugar.',
      custom: 'Personalizado',
      customDesc: 'Gerencie todas as configurações manualmente. Selecionar este modo salva apenas a flag sem alterar nenhum parâmetro.',
      positionSize: 'Tamanho da posição',
      stopLoss: 'Stop-loss',
      entryFilter: 'Filtro de entrada',
      maxEntries: 'Máx entradas/min',
      walletMargin: 'Margem na carteira',
    },
